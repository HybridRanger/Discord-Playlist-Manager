...
import { Constants, Platform, Utils as Utils2 } from "youtubei.js";
      ...
      pull(controller) {
        ...
        return new Promise(async (resolve, reject) => {
          ...
          try {
            ...
            for await (const chunk of Utils2.streamToIterable(readable)) {
...
// lib/utils/index.ts
import { Platform as Platform2 } from "youtubei.js";
...
function defaultFetch(_player, input, init, proxy) {
  ...
  if (proxy) {
    ...
    return Platform2.shim.fetch(input, requestInit);
  } else {
    return Platform2.shim.fetch(input, requestInit);
  }
}
...
async function createServerAbrStream(track, innertube, ext) {
  ...
  const audioStream = new PassThrough2();
